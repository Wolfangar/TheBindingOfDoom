...
namespace MazeGen
{
    public class Node
    {
        public enum Room_Type {START, END, NORMAL};
        public Room_Type currentRoomType = Room_Type.NORMAL;
        public Room selectedRoom { get; set; }//from json
        public List<Position> thingPositionsLeft { get; set; }
        public List<ThingType> thingsInstanciated = new List<ThingType>();

        public Door DoorLeft { get; set; }
        public Door DoorRight { get; set; }
        public Door DoorUp { get; set; }
        public Door DoorDown { get; set; }
        ...
        /// </summary>
        /// <param name="index">Up = 0 Left = 3 Down = 2 Right = 1</param>
